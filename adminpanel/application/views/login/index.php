   ...
   <body>
      ...
      <section>
         <div class="container-fluid">
            <div class="row">
               <div class="col-xl-5"><img class="bg-img-cover bg-center" src="<?php echo base_url();?>assets/images/login/3.jpg" alt="looginpage"></div>
               <div class="col-xl-7 p-0">
                  <div class="login-card">
              <form class="theme-form login-form" action="<?php echo base_url('login/loginSubmit')?>" method="POST">
                <h4>Login</h4>
                ...
                <div class="form-group">
                  <div class="checkbox">
                    <input id="checkbox1" type="checkbox" <?php if(isset($_COOKIE['email']) && isset($_COOKIE['password'])){echo "checked='checked'"; } ?> value="1" name="remember_me">

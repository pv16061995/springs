...
<div class="main-header-right row m-0">
    ...
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo base_url();?>assets/images/logo.png" alt=""></a></div>
    <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo base_url();?>assets/images/dark-logo.png" alt=""></a></div>
    ...
    <ul class="nav-menus">
        ...
        <ul class="chat-dropdown onhover-show-div">
            ...
            <li>
            <div class="media"><img class="img-fluid rounded-circle me-3" src="<?php echo base_url();?>assets/images/1.jpg" alt="">
            ...
            <li>
            <div class="media"><img class="img-fluid rounded-circle me-3" src="<?php echo base_url();?>assets/images/2.jpg" alt="">

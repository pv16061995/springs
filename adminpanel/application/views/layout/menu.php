...
<?php
      ...
      foreach ($menudata as $value) {
        ...
        // print_r(isset($permission[$value["permission_name"]]));
        // echo $value["permission_name"];
      ...
      if(count($menuparentdata)>0){
         $href="javascript:;";
          ...
          $menu_new .= '<li class="dropdown">
                            <a class="nav-link menu-title" href="'.$href.'"><i class="'.$value['icon'].'"></i>&nbsp;<span>'.$value['name'].'</span></a>';
         if(isset($menuparentdata)){
         $menu_new .= '<ul class="nav-submenu menu-content">';
         foreach ($menuparentdata as $val) {
          // print_r($permission);
          // print_r($permission[$val["permission_name"]]);

...
class Permissionsusers extends CI_Model {
	...
	public function getMenuList(){
		$this->db->where('status',1);
		return $query = $this->db->get('menus');
	}

	public function savePermission($data){
		$insert = $this->db->insert('permission_users', $data);
        if($insert){

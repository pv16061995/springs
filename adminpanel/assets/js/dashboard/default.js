...
var chartTimelineEl = document.querySelector("#chart-timeline-dashbord");
if (chartTimelineEl) {
    var charttimeline = new ApexCharts(chartTimelineEl, options);
...
var chart17El = document.querySelector("#chart-dashbord");
if (chart17El) {
    var chart17 = new ApexCharts(chart17El, options17);
    chart17.render();
}
// chart-4 dashbord
var options21 = {
...
var chart21El = document.querySelector("#chart-3dash");
if (chart21El) {
    var chart21 = new ApexCharts(chart21El, options21);
    chart21.render();
}
//column chart
var options54 = {
...
var chart54El = document.querySelector("#chart-unique-2");
if (chart54El) {
    var chart54 = new ApexCharts(chart54El, options54);
    chart54.render();
}
//new column charts
var options55 = {
...
var chart55El = document.querySelector("#user-activation-dash-2");
if (chart55El) {
    var chart55 = new ApexCharts(chart55El, options55);
    chart55.render();
}